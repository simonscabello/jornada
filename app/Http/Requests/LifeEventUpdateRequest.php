...
class LifeEventUpdateRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->route('lifeEvent')->user_id === auth()->id();
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'remove_images.*.exists' => 'Uma das imagens selecionadas para remoção não existe',
        ];
    }
}
