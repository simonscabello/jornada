                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('daily-logs.update', $dailyLog) }}" class="space-y-6">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <a href="{{ route('daily-logs.show', $dailyLog) }}" class="inline-flex items-center px-4 py-2 bg-gray-100 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-200">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
