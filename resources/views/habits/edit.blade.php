        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <p class="text-gray-600 mb-6">Ajustar seus hábitos é parte natural do processo de desenvolvimento pessoal. Faça as alterações que achar necessárias.</p>
                    ...
                    <form method="POST" action="{{ route('habits.update', $habit) }}" class="space-y-6">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <a href="{{ route('habits.show', $habit) }}" class="inline-flex items-center px-4 py-2 bg-gray-100 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-200">
