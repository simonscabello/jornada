            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">Acompanhe seu progresso e mantenha seus hábitos em dia.</p>
                        <a href="{{ route('habits.index') }}" class="inline-flex items-center text-indigo-600 hover:text-indigo-800">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">Registre seus pensamentos e sentimentos do dia.</p>
                        <a href="{{ route('daily-logs.index') }}" class="inline-flex items-center text-indigo-600 hover:text-indigo-800">
